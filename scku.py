...
os.system('clear')
print logo
print '\x1b[97;1mHack instagram Target'
print '\x1b[97;1mSilahkan cantumkan semua password di file \x1b[91;1mpass.txt'
print ''
